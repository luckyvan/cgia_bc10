...
public interface PublisherEntityHome extends EJBLocalHome {
  public PublisherEntity create( 
    Integer publisherID
    ,String name
    ) throws EJBException, CreateException;
  public PublisherEntity findByPrimaryKey(Integer id)
